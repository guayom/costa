json.data @propiedades.each do |propiedad|
  ...
  json.provincia propiedad.provincia ? propiedad.provincia : ""
  json.canton propiedad.canton ? propiedad.canton : ""
  json.distrito propiedad.distrito ? propiedad.distrito : ""
  json.landArea propiedad.area_terreno
  json.constructionArea propiedad.area_construccion
  json.storeys propiedad.pisos
  json.locatedAtFloor propiedad.ubicado_en_piso != nil ? propiedad.ubicado_en_piso : 0
  ...
  json.parkingKind propiedad.tipo_de_estacionamiento ? propiedad.tipo_de_estacionamiento : ""
  ...
  json.cover propiedad.cover ? propiedad.cover : ""
